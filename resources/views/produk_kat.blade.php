<x-home-layout>
    <div class="flex flex-col justify-center w-full bg-kuning min-h-screen h-max">
        <div class="flex flex-col mt-24 mx-auto">
            ...
            <h3 class="font-bebas text-black text-[40px] tracking-[.20em] mt-10">Kategori : {{$kategori}}</h3>
            @if($produk->isEmpty())
            <h3 class="font-bebas text-oranyet text-[40px] tracking-[.20em] mx-auto mt-40">Healthy Lifestyle Meal Plan</h3>
            @else
